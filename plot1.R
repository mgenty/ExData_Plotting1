...
#               Power Histogram With Global Active Power 
#               In Kilowatts On The X-Axis And The Frequency 
...
# ==========================================================================
# Set Up The Plot (On Screen First):
# ==========================================================================

# Plot The Histogram Of Global Active Power For The Two Days In Question:
hist(powerDF$GlobalActivePower, breaks = 12, col = "red", 
...
# Note: Opening The plot1.png In Preview On The Mac
