...
#               Consumption Dataset Into A Four-Panel 
#               Ensemble Graph With The Days On The 
#               X-Axis And Various Energy Variables 
#               On The Y-Axis For A Single Household 
#               Over The Two-Day Period From 01Feb2007 
#               To 02Feb2007.
#
...
# Plot 2:
plot(powerDF$DateAndTime, powerDF$Voltage, 
    xlab = "datetime", ylab = "Voltage", 
    type = "n")
lines(powerDF$DateAndTime, powerDF$Voltage)

# Plot 3:
plot(powerDF$DateAndTime, powerDF$SubMetering1, 
    xlab = "", ylab = "Energy sub metering", 
    type = "n")
lines(powerDF$DateAndTime, powerDF$SubMetering1, col = "black")
lines(powerDF$DateAndTime, powerDF$SubMetering2, col = "red")
lines(powerDF$DateAndTime, powerDF$SubMetering3, col = "blue")
legend("topright", bty = "n", lty = 1, col = c("black", "red", "blue"),
    legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))

# Plot 4:
plot(powerDF$DateAndTime, powerDF$GlobalReactivePower, 
    xlab = "datetime", ylab = "Global_reactive_power", 
    type = "n")
lines(powerDF$DateAndTime, powerDF$GlobalReactivePower)

# Close The Graphics Device:
dev.off()

# Note: Opening The plot4.png In Preview On The Mac
